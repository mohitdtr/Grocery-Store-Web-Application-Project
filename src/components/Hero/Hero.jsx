...
const Hero = () => {
  return (
    <section>
        <div className='min-h-screen max-w-[1400px] mx-auto px-10 flex  items-center md:flex-row flex-col md:pt-25 pt-35 '>
         {/* Hero Content  */}
         <div className='flex-1'>
              ...
              <p className='text-zincs-600 md:text-lg text-md  max-w-[530px] mt-5 mb-10 '>
